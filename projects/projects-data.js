...
const PROJECTS = [
  // ---------- EXISTING PROJECTS ----------
  {
    ...
    samples: [{ file: "1.jpeg", caption: "Field monitoring dashboard" }],
...

  {
    ...
    github:
      "https://github.com/khadkaabishek/Automated-Two-Wheeler-Violation-Detection-and-E-Challan-System",
    liveUrl: "",
  ...
  },
  {
    id: "spyder-robot",
    title: "Spyder Robot",
    thumbnail: "assets/spyder-robot.jpeg",
    tagline:
      "A four-legged robot with a browser control panel served straight from the ESP32.",
    description:
    ...
    samples: [
      { file: "robot.jpeg", caption: "Concept render" },
      { file: "1.svg", caption: "Concept render" },
    ],
    simulation: "spyder",
    simType: "custom",
  },
  {
    ...
    tagline:
      "A bilingual civic-reporting platform with voting, ward discussions, and an admin resolution pipeline.",
    description:
  ...
  },
  {
    ...
    tagline:
      "A Next.js site + admin dashboard for the Computer Engineering Innovation & Tech Club at NCIT.",
    description:
